          ...
          <div className='mb-3'>
            <div className='relative mb-4 flex w-full flex-wrap items-stretch '>
              ...
              <div className='relative flex-auto justify-end'>
                <input
                  type='search'
                  className='absolute right-0 block w-f rounded border border-solid border-neutral-300 bg-transparent bg-clip-padding pl-3 pr-10 pr-3 py-[0.25rem] text-base font-normal leading-[1.6] text-neutral-700 outline-none transition duration-200 ease-in-out focus:z-[3] focus:border-primary focus:text-neutral-700 focus:shadow-[inset_0_0_0_1px_rgb(59,113,202)] focus:outline-none dark:border-neutral-600 dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:focus:border-primary'
                  placeholder='Search'
                  aria-label='Search'
